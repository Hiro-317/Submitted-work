...
#include "Banadrill/BananaBossBanadrillManager.h"
#include "../../../../../../Common/Vector3.h"

class BananaBossDrillState : public CharacterStateBase
{
public:
	/// <summary>
	/// コンストラクタ
	...
	~BananaBossDrillState()override = default;
